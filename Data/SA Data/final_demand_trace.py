...
demand_dir = 'Demand/Intermediate/'
gen_dir = 'Generation/Copper Plate/'
...
# Add the hydrogen demand to the two Honours regions (split evenly)
...
demand.to_csv('Demand/Copper Plate/StepChangeOperationalDemand.csv', index=False)

eyre_demand_no_h20.to_csv('Demand/Multi Nodal/EyrePeninsulaDemand.csv', index=False)
north_demand_no_h20.to_csv('Demand/Multi Nodal/TheNorthDemand.csv', index=False)